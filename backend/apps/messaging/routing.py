...
from .consumers import ws_connect, ws_receive, ws_disconnect, chat_join, chat_leave, chat_send, chat_in_dialog, send_notification_async
...
custom_routing = [
    ...
    route("chat.receive", chat_in_dialog, command="^in_dialog$"),
    route("chat.receive", send_notification_async, command="^notification$"),
]
